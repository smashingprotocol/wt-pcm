...
public class PDPNewAdditionalInCartSavingsPriceDisplay {
	...
	@Test
	public void PDP_New_Additional_InCart_Savings_Price_Display() throws Exception{
		...
		try{
			...
			for(int i = 1; i <= rowCtr; i++){
				...
				testStatus = verifyXPath.isfound(Config.driver, pr.getProperty("PDP_NEW_LINK_CLICKHERELOWERPRICE_XPATH"));
